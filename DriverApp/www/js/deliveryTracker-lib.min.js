  ...
  function ($window) {
    ...
    return {
      ...
      link: function (scope, element) {
        ...
        if (!scope.height) scope.height = 300;
        if (!scope.width) scope.width = $window.innerWidth;
        ...
        scope.onResize = function() {
            ...
            var dataURL = scope.signaturePad.toDataURL();
            if (!scope.signaturePad.isEmpty()) {
                scope.signaturePad.fromDataURL(dataURL);
            }
          //var ratio =  Math.max($window.devicePixelRatio || 1.0);
